...
trasa_ova_fm = [[15.4, 40.2], [20.1, 30.5], [10.0, 25.3], [5.5, 15.8], [8.2, 35.1], [15.4, 40.2]]

trasa_ova_fm.append([12.3, 22.4])

trasa_ova_fm.insert(2, [18.5, 28.7])

print("\nTrasa OVA-FM:", trasa_ova_fm)

sorted_by_lat = sorted(trasa_ova_fm, key=lambda point: point[1])
print("Body seřazené podle lat:", sorted_by_lat)

avg_lon = sum(point[0] for point in trasa_ova_fm) / len(trasa_ova_fm)
avg_lat = sum(point[1] for point in trasa_ova_fm) / len(trasa_ova_fm)
