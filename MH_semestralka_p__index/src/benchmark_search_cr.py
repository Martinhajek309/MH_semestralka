"""Benchmark point searches over the Czech Republic in EPSG:5514."""
...
QUERY_WINDOW_SIZES_M = (5000, 20000, 50000)
QUERY_COUNT = 1000
...
def result_row(dataset_size: int, window_size_m: int, result: MethodResult) -> dict[str, object]:
...
def save_results(rows: list[dict[str, object]]) -> None:
    output_path = RESULTS_DIR / "benchmark_search_cr.csv"
...
def main() -> None:
    ...
    save_results(rows)
    print(f"Saved {RESULTS_DIR / 'benchmark_search_cr.csv'}")
